# azurelocal-ranger — Claude Code Context
...
- `azurelocal-ranger-engineer` (model: sonnet) — Expert in `azurelocal-ranger`: deep knowledge of this repo's structure, conventions, and development workflow.
