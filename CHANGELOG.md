...
* **claude:** add Claude Code scaffold ([203172f](https://github.com/AzureLocal/azurelocal-ranger/commit/203172f637d732aa39125609d688c6040858de99))
...
* **analyzer:** suppress unavoidable ConvertTo-SecureString error in Azure CLI auth ([7fc6341](https://github.com/AzureLocal/azurelocal-ranger/commit/7fc63413d31cbcc8a43f5535483cce80f3e9f899))
...
* **tests:** migrate Pester suite off removed Assert-MockCalled; cut v2.6.6 ([dc4c40a](https://github.com/AzureLocal/azurelocal-ranger/commit/dc4c40ad24b58305988fb3b2c1e7a7517f83740c))
...
## [2.6.6] — Subscription-Scoped Discovery & Auth-Context Hardening (2026-07-11)
...
- Migrated the Pester unit suite from the removed `Assert-MockCalled` command to `Should -Invoke`, restoring green CI on Pester 5.6+/6.x runners.

### Fixed

- Azure/Arc and local name-resolution failures now surface actionable warnings instead of being visible only in debug logs.

## [2.6.5] — Credential UX & Discovery Hardening (2026-04-18)
